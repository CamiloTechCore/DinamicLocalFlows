/**
 * Componente Header con navegación y controles
 */
import React from 'react';

const Header = ({ onToggleSidebar, onViewModeToggle, viewMode }) => {
  return (
    <header className="header">
      ...
      <div className="header-right">
        <button 
          ...
          title={`Cambiar a vista ${viewMode === '2d' ? '3D' : '2D'}`}
        >
          {viewMode === '2d' ? (
